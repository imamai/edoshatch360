...
/**
 * Not everything is a card (spec §41). Border + surface is the default
 * container; `raised` is reserved for the one thing on a screen that should
 * lift off the page, not stamped on every block.
 */
