...
const VARIANTS: Record<Variant, string> = {
  primary:
    "bg-brand text-white hover:bg-brand-dark active:bg-brand-darker shadow-card disabled:bg-brand/50",
  secondary:
  ...
  gold: "bg-gold text-brand-darker font-semibold hover:bg-gold-dark hover:text-white disabled:opacity-50",
};

const SIZES: Record<Size, string> = {
  // Touch targets stay at least 44px tall on md/lg (spec §59, §15).
