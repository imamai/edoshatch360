...
export async function proxy(request: NextRequest) {
  ...
  // A signed-in user has no reason to sit on the auth screens.
...
export const config = {
  matcher: [
     ...
     */
    "/((?!_next/static|_next/image|favicon.ico|images/|icons/|manifest.json|sw.js|.*\\.(?:svg|png|jpg|jpeg|gif|webp|avif|ico|woff2?)$).*)",
  ],
};
